...
export default function SummaryCard({ income, expense, month, year }) {
  ...
  return (
    <div className="bg-gradient-to-br from-[#688c76] to-[#425b4b] text-surface rounded-2xl p-6 shadow-soft mb-5 relative overflow-hidden group">
      <div className="relative z-10 flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex justify-between items-center text-xs px-1">
            <span className="text-surface/80">Rata-Rata Pengeluaran / Hari:</span>
            <span className="text-surface font-semibold">{formatCurrency(averageDailyExpense)}</span>
          </div>
        </div>
      </div>
    </div>
